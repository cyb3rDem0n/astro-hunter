<!--
Recuperato dal commit eaa8b24 ("directive for claude and rules for devs"),
dove viveva come README.md prima della ristrutturazione del 09/09/2026.
Livelli di heading normalizzati di uno: le sezioni erano h1 e rendevano
il documento una parete di titoli allo stesso livello.
Contenuto invariato.
-->
